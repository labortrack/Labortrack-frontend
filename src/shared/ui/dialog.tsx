    ...
    <DialogPrimitive.Portal>
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute right-4 top-4 rounded-control p-1.5 text-foreground-muted transition hover:bg-muted hover:text-foreground"
          aria-label="Cerrar"
        >
          <X className="size-5" />
        </DialogPrimitive.Close>
...
export function DialogHeader({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "mb-5 space-y-1 border-b border-border pb-4 pr-8",
        className,
      )}
      {...props}
    />
