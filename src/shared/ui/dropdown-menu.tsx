  ...
  return (
    <DropdownPrimitive.Portal>
      <DropdownPrimitive.Content
        ...
        className={cn(
          "z-[70] min-w-40 rounded-lg border border-border bg-card p-1 shadow-floating",
          className,
        )}
        {...props}
      />
...
export function DropdownMenuItem({
  ...
  return (
    <DropdownPrimitive.Item
      className={cn(
        "flex cursor-default items-center gap-2 rounded-control px-3 py-2 text-sm outline-none data-[highlighted]:bg-muted data-[disabled]:opacity-50",
        className,
      )}
      {...props}
    />
