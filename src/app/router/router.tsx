...
import { DashboardPage, ForgotPasswordPage, LoginPage, ResetPasswordPage, UsuariosPage } from "./lazyPages";

const suspense = (element: ReactNode) => <Suspense fallback={<LoadingState />}>{element}</Suspense>;
...
export const router = createBrowserRouter([
  { errorElement: <ErrorPage />, children: [
    ...
    { element: <ProtectedRoute />, children: [{ element: <AppLayout />, children: [
      ...
      { path: "/usuarios", element: <RoleRoute allowed={["ROLE_ADMIN", "ROLE_RRHH"]}>{suspense(<UsuariosPage />)}</RoleRoute> },
    ] }] },
